...
<details>
<summary>How to calculate manually? (GCD, LCM, and Prime Factors)</summary>
...
### Calculating the LCM
We multiply **all** the prime factors found:
$$2 \times 3 \times 2 \times 3 = 36$$
**LCM (12, 18) = 36**

### Calculating the GCD
We multiply only the factors that divided **all** the numbers at the same time (marked in bold):
$$2 \times 3 = 6$$
**GCD (12, 18) = 6**
