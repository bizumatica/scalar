...
1. Choose between **Simple** mode (two quantities) or **Compound** mode (three or more quantities).
2. Define if the relationship is **Direct** (when one increases, the other also increases) or **Inverse** (when one increases, the other decreases).
3. Enter the known values, and Scalar will calculate the value of **X** instantly.

<details>
<summary>View Theory and Difference between Direct and Inverse</summary>
